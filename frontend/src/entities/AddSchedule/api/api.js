...
export function deleteSchedule(schedule_id,setAugust,crntClickedDay, crntClickedIndexOfSchedules) {
    ...
    if (isLogin()) {
        ...
        setAugust((prev) => {
            ...
            list[crntClickedDay].splice(crntClickedIndexOfSchedules, 1);
            return list;
        });
    }
